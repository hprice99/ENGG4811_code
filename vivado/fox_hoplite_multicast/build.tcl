...
#
# Generated by Vivado on Fri Oct 29 13:44:31 AEST 2021
...
#
#    "${origin_dir}/../../hdl/ip/hoplite_router_ila/hoplite_router_ila.xci"
...
#    "${origin_dir}/../../hdl/ip/multicast_combined_ila/multicast_combined_ila.xci"
...
#    "${origin_dir}/../../hdl/ip/multicast_ila/multicast_ila.xci"
...
set_property -name "webtalk.xsim_launch_sim" -value "1679" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../../hdl/ip/hoplite_router_ila/hoplite_router_ila.xci"] \
 ...
 [file normalize "${origin_dir}/../../hdl/ip/multicast_combined_ila/multicast_combined_ila.xci"] \
...
set file "$origin_dir/../../hdl/ip/hoplite_router_ila/hoplite_router_ila.xci"
...
set file "$origin_dir/../../hdl/ip/multicast_combined_ila/multicast_combined_ila.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../../hdl/ip/multicast_ila/multicast_ila.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../hdl/ip/multicast_ila/multicast_ila.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
