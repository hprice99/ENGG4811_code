...
#
# build.tcl: Tcl script for re-creating project 'single_core'
#
# Generated by Vivado on Fri Oct 29 15:23:13 AEST 2021
...
#    "${origin_dir}/../../hdl/single_core/src/io.vh"
#    "${origin_dir}/../../hdl/single_core/src/system_single_core.v"
#    "${origin_dir}/../../hdl/single_core/src/firmware_config.vhd"
#    "${origin_dir}/../../hdl/single_core/src/packet_defs.vhd"
#    "${origin_dir}/../../hdl/packages/math_functions.vhd"
#    "${origin_dir}/../../hdl/single_core/src/matrix_config.vhd"
#    "${origin_dir}/../../hdl/single_core/src/fox_defs.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/fifo_sync.vhd"
#    "${origin_dir}/../../hdl/single_core/src/message_decoder.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/rom.vhd"
#    "${origin_dir}/../../hdl/single_core/src/top_single_core.vhd"
...
#    "${origin_dir}/../../hdl/single_core/src/board_top_single_core.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/pipeline.vhd"
#    "${origin_dir}/../../firmware/single_core/firmware_single_core.hex"
#    "${origin_dir}/../../hdl/single_core/memory/combined.mif"
...
#    "${origin_dir}/../../constraints/single_core/Nexys-4-DDR-Master-Single-Core.xdc"
#    "${origin_dir}/../../hdl/picorv32/src/picorv32.v"
#    "${origin_dir}/../../hdl/single_core/src/system_single_core.v"
#    "${origin_dir}/../../hdl/building_blocks/src/fifo_sync.vhd"
#    "${origin_dir}/../../hdl/single_core/src/firmware_config.vhd"
...
#    "${origin_dir}/../../hdl/submodules/uart-for-fpga/rtl/comp/uart_parity.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/uart_tx_buffered.vhd"
#    "${origin_dir}/../../hdl/single_core/tb/top_tb.vhd"
#    "${origin_dir}/../../firmware/single_core/firmware_single_core.hex"
#    "${origin_dir}/../../firmware/single_core/firmware_single_core_tb.hex"
#    "${origin_dir}/../../hdl/packages/conv_functions.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/fifo_sync_memory_initialise.vhd"
#    "${origin_dir}/../../hdl/packages/random.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/fifo_sync_wrapper.vhd"
#    "${origin_dir}/../../hdl/single_core/memory/combined.mif"
#    "${origin_dir}/../../vivado/single_core/top_tb_behav.wcfg"
#
#*****************************************************************************************
...
set _xil_proj_name_ "single_core"
...
set orig_proj_dir "[file normalize "$origin_dir/single_core"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../hdl/single_core/src/io.vh"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/system_single_core.v"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/firmware_config.vhd"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/packet_defs.vhd"] \
 [file normalize "${origin_dir}/../../hdl/packages/math_functions.vhd"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/matrix_config.vhd"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/fox_defs.vhd"] \
 [file normalize "${origin_dir}/../../hdl/building_blocks/src/fifo_sync.vhd"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/message_decoder.vhd"] \
 [file normalize "${origin_dir}/../../hdl/building_blocks/src/rom.vhd"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/top_single_core.vhd"] \
 ...
 [file normalize "${origin_dir}/../../hdl/single_core/src/board_top_single_core.vhd"] \
 [file normalize "${origin_dir}/../../hdl/building_blocks/src/pipeline.vhd"] \
 [file normalize "${origin_dir}/../../firmware/single_core/firmware_single_core.hex"] \
 [file normalize "${origin_dir}/../../hdl/single_core/memory/combined.mif"] \
...
set file "$origin_dir/../../hdl/single_core/src/io.vh"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj

set file "$origin_dir/../../hdl/single_core/src/firmware_config.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../hdl/single_core/src/packet_defs.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../hdl/single_core/src/matrix_config.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../hdl/single_core/src/fox_defs.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../hdl/single_core/src/message_decoder.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../hdl/single_core/src/top_single_core.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../hdl/single_core/src/board_top_single_core.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../firmware/single_core/firmware_single_core.hex"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj

set file "$origin_dir/../../hdl/single_core/memory/combined.mif"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../constraints/single_core/Nexys-4-DDR-Master-Single-Core.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../constraints/single_core/Nexys-4-DDR-Master-Single-Core.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
# Create 'Single_core' fileset (if not found)
if {[string equal [get_filesets -quiet Single_core] ""]} {
  create_fileset -simset Single_core
}

# Set 'Single_core' fileset object
set obj [get_filesets Single_core]
set files [list \
 [file normalize "${origin_dir}/../../hdl/picorv32/src/picorv32.v"] \
 [file normalize "${origin_dir}/../../hdl/single_core/src/system_single_core.v"] \
 [file normalize "${origin_dir}/../../hdl/building_blocks/src/fifo_sync.vhd"] \
 ...
 [file normalize "${origin_dir}/../../hdl/submodules/uart-for-fpga/rtl/comp/uart_parity.vhd"] \
 [file normalize "${origin_dir}/../../hdl/building_blocks/src/uart_tx_buffered.vhd"] \
 [file normalize "${origin_dir}/../../hdl/single_core/tb/top_tb.vhd"] \
 [file normalize "${origin_dir}/../../firmware/single_core/firmware_single_core.hex"] \
 [file normalize "${origin_dir}/../../firmware/single_core/firmware_single_core_tb.hex"] \
...
# Set 'Single_core' fileset file properties for remote files
set file "$origin_dir/../../hdl/building_blocks/src/fifo_sync.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Single_core] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../hdl/single_core/tb/top_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Single_core] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../firmware/single_core/firmware_single_core_tb.hex"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Single_core] [list "*$file"]]
set_property -name "file_type" -value "Memory Initialization Files" -objects $file_obj
...
# Set 'Single_core' fileset file properties for local files
# None

# Set 'Single_core' fileset properties
set obj [get_filesets Single_core]
...
set obj [get_runs synth_1_copy_1]
set_property -name "auto_incremental_checkpoint.directory" -value "${origin_dir}/../../vivado/single_core/ENGG4811_vivado.srcs/utils_1/imports/synth_1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
