...
#
# Generated by Vivado on Fri Oct 29 14:48:55 AEST 2021
...
#    "${origin_dir}/../../hdl/hoplite/src/hoplite_router.vhd"
...
#    "${origin_dir}/../../hdl/hoplite/tb/hoplite_router_tb.vhd"
#    "${origin_dir}/../../hdl/building_blocks/src/pipeline.vhd"
...
#    "${origin_dir}/../../hdl/hoplite/src/hoplite_router.vhd"
#    "${origin_dir}/../../hdl/hoplite/tb/hoplite_tb_node.vhd"
#    "${origin_dir}/../../hdl/hoplite/tb/hoplite_tb_pe.vhd"
#    "${origin_dir}/../../hdl/hoplite/src/nic_dual.vhd"
#    "${origin_dir}/../../hdl/hoplite/tb/hoplite_tb.vhd"
...
set_property -name "webtalk.xsim_launch_sim" -value "1184" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../hdl/hoplite/src/hoplite_router.vhd"] \
...
set file "$origin_dir/../../hdl/hoplite/src/hoplite_router.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../hdl/hoplite/tb/hoplite_router_tb.vhd"] \
 [file normalize "${origin_dir}/../../hdl/building_blocks/src/pipeline.vhd"] \
...
set file "$origin_dir/../../hdl/hoplite/tb/hoplite_router_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Hoplite_router] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set_property -name "top" -value "hoplite_router_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../hdl/hoplite/src/hoplite_router.vhd"] \
 [file normalize "${origin_dir}/../../hdl/hoplite/tb/hoplite_tb_node.vhd"] \
 [file normalize "${origin_dir}/../../hdl/hoplite/tb/hoplite_tb_pe.vhd"] \
 [file normalize "${origin_dir}/../../hdl/hoplite/src/nic_dual.vhd"] \
 [file normalize "${origin_dir}/../../hdl/hoplite/tb/hoplite_tb.vhd"] \
...
set file "$origin_dir/../../hdl/hoplite/tb/hoplite_tb_node.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Hoplite_network] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../hdl/hoplite/tb/hoplite_tb_pe.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Hoplite_network] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/../../hdl/hoplite/tb/hoplite_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets Hoplite_network] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set_property -name "hbs.configure_design_for_hier_access" -value "1" -objects $obj
set_property -name "source_set" -value "" -objects $obj
set_property -name "top" -value "hoplite_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
