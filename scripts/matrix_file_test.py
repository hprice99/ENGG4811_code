...
foxFirmware = Firmware(binaryName="firmware_hoplite.hex", memSize=4096)
resultFirmware = Firmware(binaryName="firmware_hoplite_result.hex", memSize=8192)

foxFirmware.write_assembly_file("fox_hoplite")
resultFirmware.write_assembly_file("fox_hoplite")
...
foxNetwork = FoxNetwork(networkRows=networkRows, networkCols=networkCols, \
            ...
            foxFirmware=foxFirmware, resultFirmware=resultFirmware)
